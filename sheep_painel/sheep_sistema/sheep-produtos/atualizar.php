            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-md-7">
                    <input type="text" class="form-control" name="titulo" placeholder="Digite o nome do produto" value="">
                  </div>
                </div>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-md-7">
                    <input type="number" class="form-control" name="valor" placeholder="Digite o valor" step="0.01" required value="">
                  </div>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-md-7">
                    <input type="text" class="form-control" name="resumo" placeholder="Digite o resumo no máximo 7 palavras" value="">
                  </div>
