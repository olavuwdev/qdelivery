    ...
    <div class="main-content">
     ...
     <!-- FIM TOKEN URL MAYKONSILVEIRA.COM.BR MAYKON SILVEIRA--->
        ...
        <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>sheep-slide/filtros/criar&token=<?= $_SESSION['timeWT'] ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_um" placeholder="Digite o título 1">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_dois" placeholder="Digite o título 2">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_tres" placeholder="Digite o título 3">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="titulo_quatro" placeholder="Digite o título 4">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="color" class="form-control" name="cor_um" placeholder="Cor1">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="color" class="form-control" name="cor_dois" placeholder="Cor2">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-md-7">
                        <input type="text" class="form-control" name="text_btn" placeholder="Digite o texto">
                      </div>
                    </div>
